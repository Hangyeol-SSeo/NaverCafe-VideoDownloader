...
### version 1.4.3
<시스템 변경> 네이버 동영상 플레이어 API 변경(v3, MPEG-DASH/XML)에 대응하여 영상을 다시 정상적으로 찾을 수 있도록 수정했습니다.
<신규 기능> 동영상 파일명 저장 시, 게시글 화면에 보이는 제목을 우선적으로 사용하여 정확도를 높였습니다.
<버그 픽스> 페이지 이동이나 동적 로딩(SPA) 환경에서도 다운로드 버튼이 사라지지 않고 올바르게 표시되도록 개선했습니다.
